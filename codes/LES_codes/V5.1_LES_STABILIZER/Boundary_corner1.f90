        ...
        !_____________________________________________________________________
        SUBROUTINE BOUNDARY_CORNER1(ch)
        ...
        drho1(i,j,k) = drho1(i,j,k) + (LZ2+0.5d0*(LZ5+LZ1))/(c*c) 

        du = 0.5d0*(LX5-LX1)/(rho_cur(i,j,k)*c) + LY3 + LZ3 

        dv = 0.5d0*(LY5-LY1)/(rho_cur(i,j,k)*c) + LZ4 + LX3

        dw = 0.5d0*(LZ5-LZ1)/(rho_cur(i,j,k)*c) + LY4 + LX4
