...
!!$OMP END PARALLEL
        ...
        CALL HIXON_BACKDIF_X(lh_s_b(i,j,k))
        CALL HIXON_FORWARD_X(lh_s_f(i,j,k))
...
!!$OMP END PARALLEL
        ...
        CALL HIXON_BACKDIF_Y(lh_s_b(i,j,k))
        CALL HIXON_FORWARD_Y(lh_s_f(i,j,k))
...
!!$OMP END PARALLEL
        ...
        CALL HIXON_BACKDIF_Z(lh_s_b(i,j,k))
        CALL HIXON_FORWARD_Z(lh_s_f(i,j,k))
