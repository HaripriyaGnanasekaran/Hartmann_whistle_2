        ...
        !______________________________________________________________________
        SUBROUTINE HIXON_BACKDIF_X(u_cur)
...
!$OMP END PARALLEL
        ...
        !______________________________________________________________________
        SUBROUTINE HIXON_FORWARD_X(u_cur)
        USE GRID_DIMENSIONS,     ONLY : NXL,NXR,NYB,NYT,NZB,NZF
        USE GRID_DIMENSIONS,     ONLY : NXO,NXB,NYSB,NYST,NZSB,NZSF
        USE GRID_SIZE_TIME_STEP, ONLY : dx1,dx,axo,dxi,d_eta_x,d_eta_x_inv
        USE HIXON_BACKWARD_PARAMETERS
...
!$OMP END PARALLEL
        ...
        !______________________________________________________________________
        SUBROUTINE HIXON_BACKDIF_Y(u_cur)
...
!$OMP END PARALLEL
        ...
        !______________________________________________________________________
        SUBROUTINE HIXON_FORWARD_Y(u_cur)
...
!$OMP END PARALLEL
        ...
        !______________________________________________________________________
        SUBROUTINE HIXON_BACKDIF_Z(u_cur)
...
!$OMP END PARALLEL
        ...
        !______________________________________________________________________
        SUBROUTINE HIXON_FORWARD_Z(u_cur)
